...
var game = new Phaser.Game(500, 300, Phaser.AUTO, 'screen', { preload: preload, create: create, update: update, render: render });
var score = 0;
var blocks;
var player_data = {
  vel: 80
...
function update() {
  ...
  {
    player.body.velocity.x = -player_data.vel;
  ...
  {
    player.body.velocity.y = -player_data.vel;
